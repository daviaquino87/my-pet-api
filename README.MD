...
#### Retorna um relatorio de spendings
...
| Parâmetro     | Tipo    | Descrição                                          |
| :------------ | :------ | :------------------------------------------------- |
| `initialDate` | `query` | **Obrigatório**. Data inicial do periodo de compra |
| `FinalDate`   | `query` | **Obrigatório**. Data final do periodo de compra   |
